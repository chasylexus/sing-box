...
type UpdateRuleSetsResult struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *UpdateRuleSetsResult) Reset() {
	*x = UpdateRuleSetsResult{}
	mi := &file_daemon_started_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateRuleSetsResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateRuleSetsResult) ProtoMessage() {}

func (x *UpdateRuleSetsResult) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_started_service_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateRuleSetsResult.ProtoReflect.Descriptor instead.
func (*UpdateRuleSetsResult) Descriptor() ([]byte, []int) {
	return file_daemon_started_service_proto_rawDescGZIP(), []int{9}
}

func (x *UpdateRuleSetsResult) GetUpdated() int32 {
	if x != nil {
		return x.Updated
	}
	return 0
...
func (x *UpdateRuleSetsResult) GetErrors() []string {
	if x != nil {
		return x.Errors
	}
	return nil
...
const file_daemon_started_service_proto_rawDesc = "" +
	...
	"\furlTestDelay\x18\x04 \x01(\x05R\furlTestDelay\"H\n" +
	"\x14UpdateRuleSetsResult\x12\x18\n" +
	"\aupdated\x18\x01 \x01(\x05R\aupdated\x12\x16\n" +
	"\x06errors\x18\x02 \x03(\tR\x06errors\"2\n" +
	...
	"\x1bUSB_BACKEND_WINDOWS_VBOXUSB\x10\x042\xa5\x1b\n" +
	...
	"\x13CloseAllConnections\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00\x12H\n" +
	"\x0eUpdateRuleSets\x12\x16.google.protobuf.Empty\x1a\x1c.daemon.UpdateRuleSetsResult\"\x00\x12M\n" +
...
var file_daemon_started_service_proto_goTypes = []any{
	...
	(*UpdateRuleSetsResult)(nil),              // 14: daemon.UpdateRuleSetsResult
...
var file_daemon_started_service_proto_depIdxs = []int32{
	...
	45,  // 16: daemon.TailscaleSSHClientMessage.start:type_name -> daemon.TailscaleSSHStart
	46,  // 17: daemon.TailscaleSSHClientMessage.input:type_name -> daemon.TailscaleSSHInput
	47,  // 18: daemon.TailscaleSSHClientMessage.resize:type_name -> daemon.TailscaleSSHResize
	49,  // 19: daemon.TailscaleSSHServerMessage.authBanner:type_name -> daemon.TailscaleSSHAuthBanner
	50,  // 20: daemon.TailscaleSSHServerMessage.ready:type_name -> daemon.TailscaleSSHReady
	51,  // 21: daemon.TailscaleSSHServerMessage.output:type_name -> daemon.TailscaleSSHOutput
	52,  // 22: daemon.TailscaleSSHServerMessage.exit:type_name -> daemon.TailscaleSSHExit
	53,  // 23: daemon.TailscaleSSHServerMessage.error:type_name -> daemon.TailscaleSSHError
	57,  // 24: daemon.TaildropInbox.files:type_name -> daemon.TaildropFile
	58,  // 25: daemon.TaildropInbox.receiving:type_name -> daemon.TaildropReceivingFile
	60,  // 26: daemon.TaildropSendClientMessage.start:type_name -> daemon.TaildropSendStart
	62,  // 27: daemon.TaildropSendClientMessage.chunk:type_name -> daemon.TaildropFileChunk
	63,  // 28: daemon.TaildropSendClientMessage.fileDone:type_name -> daemon.TaildropFileDone
	61,  // 29: daemon.TaildropSendStart.files:type_name -> daemon.TaildropOutgoingFile
	65,  // 30: daemon.TaildropSendServerMessage.progress:type_name -> daemon.TaildropSendProgress
	73,  // 31: daemon.USBProviderMessage.attach:type_name -> daemon.USBDeviceAttach
	75,  // 32: daemon.USBProviderMessage.detach:type_name -> daemon.USBDeviceDetach
	78,  // 33: daemon.USBProviderMessage.urbResponse:type_name -> daemon.USBURBResponse
	76,  // 34: daemon.USBServerMessage.ready:type_name -> daemon.USBDeviceReady
	77,  // 35: daemon.USBServerMessage.urbRequest:type_name -> daemon.USBURBRequest
	80,  // 36: daemon.USBServerMessage.abort:type_name -> daemon.USBEndpointAbort
	81,  // 37: daemon.USBServerMessage.error:type_name -> daemon.USBError
	74,  // 38: daemon.USBDeviceDescriptor.interfaces:type_name -> daemon.USBInterface
	72,  // 39: daemon.USBDeviceAttach.descriptor:type_name -> daemon.USBDeviceDescriptor
	79,  // 40: daemon.USBURBRequest.isoPackets:type_name -> daemon.USBIsoPacket
	79,  // 41: daemon.USBURBResponse.isoPackets:type_name -> daemon.USBIsoPacket
	83,  // 42: daemon.USBIPServerStatusUpdate.servers:type_name -> daemon.USBIPServerStatus
	84,  // 43: daemon.USBIPServerStatus.devices:type_name -> daemon.USBSharedDevice
	72,  // 44: daemon.USBSharedDevice.descriptor:type_name -> daemon.USBDeviceDescriptor
	...
	86,  // 47: daemon.OpenConnectStatusUpdate.endpoints:type_name -> daemon.OpenConnectEndpointStatus
	88,  // 48: daemon.OpenConnectEndpointStatus.authChallenge:type_name -> daemon.OpenConnectAuthChallenge
	87,  // 49: daemon.OpenConnectEndpointStatus.tunnelInfo:type_name -> daemon.OpenConnectTunnelInfo
	89,  // 50: daemon.OpenConnectAuthChallenge.form:type_name -> daemon.OpenConnectAuthForm
	92,  // 51: daemon.OpenConnectAuthChallenge.browser:type_name -> daemon.OpenConnectBrowserRequest
	90,  // 52: daemon.OpenConnectAuthForm.fields:type_name -> daemon.OpenConnectAuthFormField
	91,  // 53: daemon.OpenConnectAuthFormField.options:type_name -> daemon.OpenConnectAuthFormChoice
	109, // 54: daemon.OpenConnectAuthFormResponse.values:type_name -> daemon.OpenConnectAuthFormResponse.ValuesEntry
	93,  // 55: daemon.OpenConnectBrowserResult.cookies:type_name -> daemon.OpenConnectBrowserCookie
	94,  // 56: daemon.OpenConnectBrowserResult.headers:type_name -> daemon.OpenConnectBrowserHeader
	95,  // 57: daemon.OpenConnectAuthResponseSubmission.form:type_name -> daemon.OpenConnectAuthFormResponse
	96,  // 58: daemon.OpenConnectAuthResponseSubmission.browser:type_name -> daemon.OpenConnectBrowserResult
	100, // 59: daemon.OpenVPNStatusUpdate.endpoints:type_name -> daemon.OpenVPNEndpointStatus
	102, // 60: daemon.OpenVPNEndpointStatus.challenge:type_name -> daemon.OpenVPNChallenge
	101, // 61: daemon.OpenVPNEndpointStatus.tunnelInfo:type_name -> daemon.OpenVPNTunnelInfo
	106, // 62: daemon.NotificationEvent.send:type_name -> daemon.Notification
	107, // 63: daemon.NotificationEvent.cancel:type_name -> daemon.NotificationCancel
	0,   // 64: daemon.Log.Message.level:type_name -> daemon.LogLevel
	110, // 65: daemon.StartedService.GetVersion:input_type -> google.protobuf.Empty
	110, // 66: daemon.StartedService.SubscribeServiceStatus:input_type -> google.protobuf.Empty
	110, // 67: daemon.StartedService.SubscribeLog:input_type -> google.protobuf.Empty
	110, // 68: daemon.StartedService.GetDefaultLogLevel:input_type -> google.protobuf.Empty
	110, // 69: daemon.StartedService.ClearLogs:input_type -> google.protobuf.Empty
	7,   // 70: daemon.StartedService.SubscribeStatus:input_type -> daemon.SubscribeStatusRequest
	110, // 71: daemon.StartedService.SubscribeGroups:input_type -> google.protobuf.Empty
	110, // 72: daemon.StartedService.GetClashModeStatus:input_type -> google.protobuf.Empty
	110, // 73: daemon.StartedService.SubscribeClashMode:input_type -> google.protobuf.Empty
	18,  // 74: daemon.StartedService.SetClashMode:input_type -> daemon.ClashMode
	15,  // 75: daemon.StartedService.URLTest:input_type -> daemon.URLTestRequest
	16,  // 76: daemon.StartedService.SelectOutbound:input_type -> daemon.SelectOutboundRequest
	17,  // 77: daemon.StartedService.SetGroupExpand:input_type -> daemon.SetGroupExpandRequest
	20,  // 78: daemon.StartedService.SubscribeConnections:input_type -> daemon.SubscribeConnectionsRequest
	25,  // 79: daemon.StartedService.CloseConnection:input_type -> daemon.CloseConnectionRequest
	110, // 80: daemon.StartedService.CloseAllConnections:input_type -> google.protobuf.Empty
	110, // 81: daemon.StartedService.UpdateRuleSets:input_type -> google.protobuf.Empty
	110, // 82: daemon.StartedService.GetDeprecatedWarnings:input_type -> google.protobuf.Empty
	110, // 83: daemon.StartedService.GetStartedAt:input_type -> google.protobuf.Empty
	110, // 84: daemon.StartedService.SubscribeOutbounds:input_type -> google.protobuf.Empty
	30,  // 85: daemon.StartedService.StartNetworkQualityTest:input_type -> daemon.NetworkQualityTestRequest
	32,  // 86: daemon.StartedService.StartSTUNTest:input_type -> daemon.STUNTestRequest
	110, // 87: daemon.StartedService.SubscribeTailscaleStatus:input_type -> google.protobuf.Empty
	38,  // 88: daemon.StartedService.StartTailscalePing:input_type -> daemon.TailscalePingRequest
	40,  // 89: daemon.StartedService.SetTailscaleExitNode:input_type -> daemon.SetTailscaleExitNodeRequest
	41,  // 90: daemon.StartedService.TailscaleLogout:input_type -> daemon.TailscaleLogoutRequest
	42,  // 91: daemon.StartedService.GetTailscaleCertificate:input_type -> daemon.TailscaleCertificateRequest
	...
	19,  // 115: daemon.StartedService.GetClashModeStatus:output_type -> daemon.ClashModeStatus
	18,  // 116: daemon.StartedService.SubscribeClashMode:output_type -> daemon.ClashMode
	...
	110, // 119: daemon.StartedService.SelectOutbound:output_type -> google.protobuf.Empty
	110, // 120: daemon.StartedService.SetGroupExpand:output_type -> google.protobuf.Empty
	22,  // 121: daemon.StartedService.SubscribeConnections:output_type -> daemon.ConnectionEvents
	110, // 122: daemon.StartedService.CloseConnection:output_type -> google.protobuf.Empty
	110, // 123: daemon.StartedService.CloseAllConnections:output_type -> google.protobuf.Empty
	14,  // 124: daemon.StartedService.UpdateRuleSets:output_type -> daemon.UpdateRuleSetsResult
	26,  // 125: daemon.StartedService.GetDeprecatedWarnings:output_type -> daemon.DeprecatedWarnings
	28,  // 126: daemon.StartedService.GetStartedAt:output_type -> daemon.StartedAt
	29,  // 127: daemon.StartedService.SubscribeOutbounds:output_type -> daemon.OutboundList
	31,  // 128: daemon.StartedService.StartNetworkQualityTest:output_type -> daemon.NetworkQualityTestProgress
	33,  // 129: daemon.StartedService.StartSTUNTest:output_type -> daemon.STUNTestProgress
	34,  // 130: daemon.StartedService.SubscribeTailscaleStatus:output_type -> daemon.TailscaleStatusUpdate
	39,  // 131: daemon.StartedService.StartTailscalePing:output_type -> daemon.TailscalePingResponse
	...
	43,  // 134: daemon.StartedService.GetTailscaleCertificate:output_type -> daemon.TailscaleCertificate
	48,  // 135: daemon.StartedService.StartTailscaleSSHSession:output_type -> daemon.TailscaleSSHServerMessage
	56,  // 136: daemon.StartedService.SubscribeTaildropInbox:output_type -> daemon.TaildropInbox
	110, // 137: daemon.StartedService.MarkTaildropInboxRead:output_type -> google.protobuf.Empty
	64,  // 138: daemon.StartedService.SendTaildropFiles:output_type -> daemon.TaildropSendServerMessage
	67,  // 139: daemon.StartedService.DownloadTaildropFile:output_type -> daemon.DownloadTaildropFileChunk
	110, // 140: daemon.StartedService.DeleteTaildropFile:output_type -> google.protobuf.Empty
	110, // 141: daemon.StartedService.CancelTaildropReceiving:output_type -> google.protobuf.Empty
	71,  // 142: daemon.StartedService.ProvideUSBDevices:output_type -> daemon.USBServerMessage
	82,  // 143: daemon.StartedService.SubscribeUSBIPServerStatus:output_type -> daemon.USBIPServerStatusUpdate
	85,  // 144: daemon.StartedService.SubscribeOpenConnectStatus:output_type -> daemon.OpenConnectStatusUpdate
	110, // 145: daemon.StartedService.SubmitOpenConnectAuthResponse:output_type -> google.protobuf.Empty
	110, // 146: daemon.StartedService.CancelOpenConnectAuthChallenge:output_type -> google.protobuf.Empty
	99,  // 147: daemon.StartedService.SubscribeOpenVPNStatus:output_type -> daemon.OpenVPNStatusUpdate
	110, // 148: daemon.StartedService.SubmitOpenVPNChallengeResponse:output_type -> google.protobuf.Empty
	110, // 149: daemon.StartedService.CancelOpenVPNChallenge:output_type -> google.protobuf.Empty
	105, // 150: daemon.StartedService.SubscribeNotifications:output_type -> daemon.NotificationEvent
