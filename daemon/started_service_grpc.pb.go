...
const (
	...
	StartedService_UpdateRuleSets_FullMethodName                 = "/daemon.StartedService/UpdateRuleSets"
...
type StartedServiceClient interface {
	...
	UpdateRuleSets(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UpdateRuleSetsResult, error)
...
func (c *startedServiceClient) UpdateRuleSets(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UpdateRuleSetsResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateRuleSetsResult)
	err := c.cc.Invoke(ctx, StartedService_UpdateRuleSets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StartedServiceServer interface {
	...
	UpdateRuleSets(context.Context, *emptypb.Empty) (*UpdateRuleSetsResult, error)
...
func (UnimplementedStartedServiceServer) UpdateRuleSets(context.Context, *emptypb.Empty) (*UpdateRuleSetsResult, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateRuleSets not implemented")
}
...
func _StartedService_UpdateRuleSets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StartedServiceServer).UpdateRuleSets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StartedService_UpdateRuleSets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StartedServiceServer).UpdateRuleSets(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StartedService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateRuleSets",
			Handler:    _StartedService_UpdateRuleSets_Handler,
		},
		{
